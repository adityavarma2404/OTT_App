    ...
    <div className="footerContainer">
      <div className="footer">
        <div className="footerOptions">
          ...
          <p className="footerButtons">About us</p>
        ...
        <div className="footerOptions">
          <h5 className="footerHeading">Need Help?</h5>
          <p className="footerButtons">Visit Help Center</p>
          <p className="footerButtons">Share feedback</p>
        </div>
        <div className="footerOptions">
